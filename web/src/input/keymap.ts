...
export const PRESS_BINDINGS: readonly KeyBinding<PressAction>[] = [
  ...
  { action: 'voice', codes: ['KeyV'], mods: { primary: false, ctrl: false, alt: false }, label: 'V', help: 'Speak a distance for the active line or face pull; units apply immediately, V confirms a bare number', group: 'tools' },
