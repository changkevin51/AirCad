...
export const PRESS_BINDINGS: readonly KeyBinding<PressAction>[] = [
  ...
  { action: 'extrude', codes: ['KeyQ'], mods: { primary: false, ctrl: false, alt: false }, label: 'Q', help: 'Push/pull the selected rectangle, triangle, or solid: pick a face, pinch and move', group: 'tools' },
  ...
  { action: 'export', codes: ['KeyE'], label: 'E', help: 'Export the current drawing or preview to a new FreeCAD document', group: 'tools' },
