...
export type RecognizedShape = RecognizedLine | RecognizedRect | RecognizedTriangle;
...
/**
 * Recognise a pen stroke (2D plane coordinates, mm) as a straight line,
 * rectangle, or triangle.  Anything else returns `shape: null` with a reason.
 */
